...
public class ActiviteServiceTest {
    ...
    public void setup() {
        ...
        public void testSaveActiviteAjouterActiviteAuResponsable() {
            Assert.assertFalse(mary.getActivites().contains(act2));
            activiteService.saveActivite(act2);
            Assert.assertTrue(mary.getActivites().contains(act2));
        }
    ...
    public void testTypeRepository() {
        Assert.assertThat(activiteService.getActiviteRepository(), instanceOf(PagingAndSortingRepository.class));
    }
